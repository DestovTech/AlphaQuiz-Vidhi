...
import 'package:flutterquiz/ui/screens/contact_us_screen.dart';
...
import 'package:flutterquiz/ui/screens/home/widgets/bottomNavbar.dart';
...
class Routes {
  ...
  static const appContactus = '/appContactus';
  ...
  static Route<dynamic>? onGenerateRouted(RouteSettings routeSettings) {
    ...
    switch (routeSettings.name) {
      ...
      case login:
        return SignInScreen.route(routeSettings);
      case signUp:
      ...
      case bottomnavbar:
        return buildbottomnavbar.route(routeSettings);
      default:

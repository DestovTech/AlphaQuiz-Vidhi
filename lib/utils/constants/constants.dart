...
const appName = 'Alpha Quiz';
const packageName = 'com.shritech.flutterquiz';
...
const databaseUrl = 'https://quiz.destov.com';
...
const setUserInAppUrl = '${baseUrl}set_user_in_app';
...
const setUserRegisterContestUrl = '${baseUrl}userregistercontest';
const checkUserRegisteredContestUrl = '${baseUrl}checkuserregistered';
const getSystemConfigUrl = '${baseUrl}get_system_configurations';
const getCoinStoreData = '${baseUrl}get_coin_store_data';

const getRazorpayDetail = '${baseUrl}get_razorpaydetail';
...
//
const isDailyAdsAvailableUrl = '${baseUrl}check_daily_ads_status';

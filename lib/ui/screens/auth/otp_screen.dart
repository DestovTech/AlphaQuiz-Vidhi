...
class _OtpScreen extends State<OtpScreen> {
  ...
  Future<void> _displayCurrentPhoneNumber() async {
    if (!mounted) return;
    try {
      ...
      if (digits.length >= 10) {
        phoneNumberController.text = digits.substring(digits.length - 10);
      }
          ...
          children: [
            ...
            builder: (context, successState) {
              ...
              if (successState is AppSettingsFetchSuccess) {
                ...
                contactInformation =
                    contactInformation.replaceAll(RegExp('</?p>'), '');
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (!codeSent) const AppLogo() else
                      const SizedBox(),
                    ...
                    SizedBox(height: size.height * 0.04),
                    if (codeSent)
                      _buildSubmitOtpContainer(contactNumber)
                    else
                      _buildRequestOtpContainer(),
                    if (codeSent) _buildResendText() else
                      const SizedBox(),
                    SizedBox(height: size.height * 0.02),
                    showOtherOptions(),
                    SizedBox(height: size.height * 0.03),
  ...
  Widget _buildSubmitOtpContainer(String contactNumber) {

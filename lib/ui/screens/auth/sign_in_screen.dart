...
class SignInScreen extends StatefulWidget {
  ...
  static Route<SignInScreen> route(RouteSettings routeSettings) {
...
class _SignInScreenState extends State<SignInScreen> {
          ...
          body: SingleChildScrollView(
            child: BlocBuilder<AppSettingsCubit, AppSettingsState>(
              ...
              builder: (context, successState) {
                ...
                // Check if the success state is AppSettingsFetchSuccess
                if (successState is AppSettingsFetchSuccess) {
                  // Extract contact information from the success state
                ...
                // Return the UI with the contact information
                return showForm(context, contactNumber);
              },
            ),
          ),
        ),
  ...
  Widget showForm(BuildContext context, String contactNumber) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            showSignIn(context, contactNumber),
            SizedBox(height: size.height * 0.02),
            showGoSignup(),
            orLabel(),
            SizedBox(height: size.height * 0.03),
            loginWith(),
            showSocialMedia(context, contactNumber),
  ...
  Widget showSignIn(BuildContext context, String contactNumber) {
    return SizedBox(
        ...
        listener: (context, state) async {
          ...
          if (state is SignInSuccess &&
            ...
            if (state.isNewUser) {
              ...
              state.authProvider == AuthProviders.email) {
            if (state.errorMessage == errorCodeAccountHasBeenDeactivated) {
              CommonUtils.showMessageBottomSheet(
                context,
  ...
  Widget showSocialMedia(BuildContext context, String contactNumber) {

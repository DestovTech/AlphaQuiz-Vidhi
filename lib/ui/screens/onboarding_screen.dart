...
class _GettingStartedScreenState extends State<IntroSliderScreen>
  ...
  late final List<({String image, String title, String desc})> slideList = [
    (
      image: AssetsUtils.getImagePath('onboarding_1.svg'),
      title: context.tr('title1')!,
      desc: context.tr('description1')!,
    ),
    (
      image: AssetsUtils.getImagePath('onboarding_2.svg'),
      title: context.tr('title2')!,
      desc: context.tr('description2')!,
    ),
    (
      image: AssetsUtils.getImagePath('onboarding_c.svg'),
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      Navigator.of(context)
                          .pushReplacementNamed(Routes.bottomnavbar, arguments: true);
                    },
                    child: Text(
                      context.tr('skip')!,
                      style: TextStyle(

...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Future<List<InAppProduct>> fetchInAppProducts() async {
    try {
      ...
      minDeposit = res['minimum_deposit'] as String;
                  ...
                  children: List.generate(
                    ...
                    (i) {
                      ...
                      return GestureDetector(
                        onTap: () => setState(() => _onPressed(menu[i].name)),
                        child: Container(
                          decoration: BoxDecoration(
                ...
                GridView.count(
                  ...
                  children: List.generate(
                    ...
                    (index) {
                      ...
                      return GestureDetector(
                        onTap: () =>
                            setState(() => _onPressed(menu[index].name)),
                        child: Container(
                          width: MediaQuery.of(context).size.width,
                          height: 200,
                          decoration: BoxDecoration(
      ...
      case 'coinStore':
        Navigator.of(context).pushNamed(
          ...
          arguments: {
            ...
            'minDeposit': UiUtils.extractNumberFromString(minDeposit),
          },
        );
        return;
    }

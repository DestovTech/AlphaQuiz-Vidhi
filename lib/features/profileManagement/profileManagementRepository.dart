...
class ProfileManagementRepository {
  ...
  Future<void> setUserInApp({
    ...
    try {
      await _profileManagementRemoteDataSource.setUserInApp(
        productId: productId,
        paymentId: paymentId,
      );
    } catch (e) {
  ...
  Future<Map<String, dynamic>> getRazorPayDetail() {
    try {
      return _profileManagementRemoteDataSource.getRazorPayDetail();
    } catch (e) {
      throw ProfileManagementException(errorMessageCode: e.toString());
    }
  }

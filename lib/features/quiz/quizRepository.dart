...
class QuizRepository {
  ...
  Future<Map<String, dynamic>> setUserRegisterContest({String? contestId}) async {
    try {
      return await _quizRemoteDataSource.setUserRegisterContest(
        contestId: contestId,
      );
    } catch (e) {
      throw QuizException(errorMessageCode: e.toString());
  ...
  Future<Map<String, dynamic>> checkUserRegisteredContest({String? contestId}) async {
    try {
      return await _quizRemoteDataSource.checkUserRegisteredContest(
        contestId: contestId,
      );
    } catch (e) {
      throw QuizException(errorMessageCode: e.toString());

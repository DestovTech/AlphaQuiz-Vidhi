...
class QuizRemoteDataSource {
  ...
  Future<Map<String, dynamic>> setUserRegisterContest({
    String? contestId,
  }) async {
    try {
      final body = <String, dynamic>{
      ...
      final response = await http.post(
        Uri.parse(setUserRegisterContestUrl),
        body: body,
        headers: await ApiUtils.getHeaders(),
      );
      final responseJson = jsonDecode(response.body) as Map<String, dynamic>;
  ...
  Future<Map<String, dynamic>> checkUserRegisteredContest({
    String? contestId,
  }) async {
    try {
      final body = <String, dynamic>{
      ...
      final response = await http.post(
        Uri.parse(checkUserRegisteredContestUrl),
        body: body,
        headers: await ApiUtils.getHeaders(),
      );
      final responseJson = jsonDecode(response.body) as Map<String, dynamic>;

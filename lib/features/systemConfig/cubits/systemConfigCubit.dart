...
class SystemConfigCubit extends Cubit<SystemConfigState> {
  ...
  int get contestCorrectAnswerCreditScore =>
      systemConfigModel?.contestCorrectAnswerCreditScore ?? 0;

  int get contestWrongAnswerDeductScore =>
      systemConfigModel?.contestWrongAnswerDeductScore ?? 0;

  int get contestTimer => systemConfigModel?.quizTimer ?? 0;
